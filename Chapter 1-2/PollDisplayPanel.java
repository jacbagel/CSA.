...
public class PollDisplayPanel extends JPanel
{
  ...
  // Declare the int fields count1, count2, count3: done
    int count1;
    int count2;
    int count3;
  // Constructor
  ...
  {
	String r = name1 + " : " + count1 + " " + name2 + " : " + count2 + " " + name3 + " : " + count3;
    // create a string here that looks like: Tami : 1 Brian : 2 Liz : 0 done
    return r;
  }
